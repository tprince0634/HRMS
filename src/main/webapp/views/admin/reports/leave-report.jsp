...
<head>
   ...
   <!-- Leave Report Sidebar Fix -->
   <style>
      /* Only the vertical admin sidebar: keep the full Reports submenu visible */
      #sidebar {
                              ...
                              <ul>
                                 ...
                                 <li class="submenu">
                                    ...
                                    <ul>
                                       ...
                                       <li><a href="${pageContext.request.contextPath}/admin/project-report">Project Report</a></li>
                                       <li><a href="${pageContext.request.contextPath}/admin/task-report">Task Report</a></li>
                                       <li><a href="user-report.html">User Report</a></li>
                                       <li><a href="${pageContext.request.contextPath}/admin/employee-report">Employee Report</a></li>
                                       <li><a href="${pageContext.request.contextPath}/admin/payslip-report">Payslip Report</a></li>
                                       ...
                                       <li><a href="${pageContext.request.contextPath}/admin/daily-report">Daily Report</a></li>
                                    </ul>
                                 </li>
                                 <li class="submenu">
         ...
         <ul>
            ...
            <li class="submenu active">
               ...
               <ul>
                  ...
                  <li>
                     <a href="${pageContext.request.contextPath}/admin/leave-report" class="active">
