...
<%--
    Department list is supplied by the AddDesignation servlet as
    request attribute "departments".
    The department service returns Map entries with DepartmentId and Name.
--%>
...
<script>
    ...
    function editDesignation(button) {
        ...
        const designationId =
            document.getElementById("editDesignationId");

        const designationName =
            document.getElementById("editDesignationName");

        const departmentId =
            document.getElementById("editDepartmentId");

        const designationStatus =
            document.getElementById("editDesignationStatus");
        ...
        if (!designationId ||
            ...
            console.error(
                "Edit designation form fields were not found."
            );
