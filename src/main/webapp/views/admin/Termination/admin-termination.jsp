                                    ...
                                    <ul class="nav-menu">
                                        ...
                                        <li class="submenu">
                                           ...
                                           <span class="menu-arrow"></span>
                                                ...
                                                <li><a href="termination.html" class="active"><span>Termination</span></a></li>
                                            </ul>
                                        </li>
                                        <li class="submenu">
                                            <a href="#">
                                ...
                                <div class="d-flex align-items-center flex-wrap row-gap-3">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end p-3">
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1 termination-sort-item" data-sort="recent">Recently Added</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1 termination-sort-item" data-sort="asc">Ascending</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1 termination-sort-item" data-sort="desc">Descending</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <c:choose>
                                                <c:when test="${not empty terminations}">
                                                    <c:forEach var="termination" items="${terminations}">
                                                        <tr data-termination-id="${termination.terminationId}">
                                                            <td>
                                                                <div class="form-check form-check-md">
                                                                    <input class="form-check-input" type="checkbox" value="${termination.terminationId}">
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <h6 class="fw-medium mb-0">
                                                                        <c:set var="employeeFound" value="false"/>

                                                                        <c:forEach var="employee" items="${employees}">
                                                                            <c:if test="${employee.userId == termination.userId}">
                                                                                <a href="javascript:void(0);">
                                                                                ...
                                                                                <c:set var="employeeFound" value="true"/>
                                                                            </c:if>
                                                                        </c:forEach>

                                                                        <c:if test="${not employeeFound}">
                                                                            <a href="javascript:void(0);">
                                                                                User #${termination.userId}
                                                                            </a>
                                                                        </c:if>
                                                                    </h6>
                                                                </div>
                                                            ...
                                                            <!-- Department -->
                                                            <td>
                                                                <c:set var="departmentFound" value="false"/>

                                                                <c:forEach var="employee" items="${employees}">
                                                                    <c:if test="${employee.userId == termination.userId}">
                                                                        <c:out value="${employee.departmentName}"/>
                                                                        <c:set var="departmentFound" value="true"/>
                                                                    </c:if>
                                                                </c:forEach>
                                                            ...
                                                            <td data-order="${termination.noticeDate}">
                                                                ${termination.noticeDate}
                                                            </td>

                                                            <td>${termination.reason}</td>

                                                            <td>${termination.resignDate}</td>

                                                            <td data-order="${termination.terminationId}">
                                                                <div class="action-icon d-inline-flex">
                                                                    <a href="javascript:void(0);"
                                                                       class="me-2 edit-termination"
                                                                       data-bs-toggle="modal"
                                                                       data-bs-target="#edit_termination"
                                                                       data-id="${termination.terminationId}"
                                                                       data-user-id="${termination.userId}"
                                                                       data-type="${termination.terminationType}"
                                                                       data-notice-date="${termination.noticeDate}"
                                                                       data-resign-date="${termination.resignDate}"
                                                                       data-reason="<c:out value='${termination.reason}'/>"
                                                                       title="Edit">
                                                                        <i class="ti ti-edit"></i>
                                                                    </a>
                                                                    <a href="javascript:void(0);" class="delete-termination" data-bs-toggle="modal" data-bs-target="#delete_modal"
                                                                       data-termination-id="${termination.terminationId}">
                                                ...
                                                <c:otherwise>
                                                    <tr>
                                                        <td colspan="8" class="text-center py-4">No termination records found.</td>
                                                    </tr>
                                                </c:otherwise>
                                            </c:choose>
                                        </tbody>
        ...
        <div class="modal fade" id="new_termination">
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    ...
                    <form action="<c:url value='/termination'/>" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="select" name="terminationType" required>
                                            <option value="">Select</option>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-icon-end position-relative">
                                            <input type="text" name="noticeDate" class="form-control datetimepicker" placeholder="dd/mm/yyyy" required>
                                            <span class="input-icon-addon">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-icon-end position-relative">
                                            <input type="text" name="resignDate" class="form-control datetimepicker" placeholder="dd/mm/yyyy" required>
                                            <span class="input-icon-addon">
                                     <i class="ti ti-calendar text-gray-7"></i>
                                  </span>
                                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content">
                    ...
                    <form action="<c:url value='/termination'/>" method="post">
                        ...
                        <input type="hidden" name="terminationId" id="editTerminationId">
                        <div class="modal-body pb-0">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="select" name="userId" id="editTerminationUserId" required>
                                            <option value="">Select</option>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Termination Type</label>
                                        <select class="select" name="terminationType" id="editTerminationType" required>
                                            <option value="">Select</option>
                                            <option value="Retirement" ${termination.terminationType == 'Retirement' ? 'selected' : ''}>Retirement</option>
                                            <option value="Insubordination" ${termination.terminationType == 'Insubordination' ? 'selected' : ''}>Insubordination</option>
                                            <option value="Lack of Skills" ${termination.terminationType == 'Lack of Skills' ? 'selected' : ''}>Lack of Skills</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Notice Date</label>
                                        <div class="input-icon-end position-relative">
                                            <input type="text" name="noticeDate" id="editNoticeDate" class="form-control datetimepicker" placeholder="dd/mm/yyyy" autocomplete="off" required>
                                            <span class="input-icon-addon">
                                     <i class="ti ti-calendar text-gray-7"></i>
                                  </span>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Reason</label>
                                        <textarea class="form-control" name="reason" id="editTerminationReason" rows="3" required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Resignation Date</label>
                                        <div class="input-icon-end position-relative">
                                            <input type="text" name="resignDate" id="editResignDate" class="form-control datetimepicker" placeholder="dd/mm/yyyy" autocomplete="off" required>
                                            <span class="input-icon-addon">
                                     <i class="ti ti-calendar text-gray-7"></i>
                                  </span>
                                        </div>
                    ...
                    <div class="modal-body text-center">
                      ...
                      <i class="ti ti-trash-x fs-36"></i>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <form action="<c:url value='/termination'/>" method="post" class="d-inline">
                                <input type="hidden" name="action" value="delete">
                                <input type="hidden" name="terminationId" id="deleteTerminationId">
...
$(document).ready(function () {
    ...
    /* =========================================================
       EDIT TERMINATION
       ========================================================= */
    $('.edit-termination').on('click', function () {

        var link = $(this);

        $('#editTerminationId').val(link.attr('data-id') || '');
        $('#editTerminationUserId').val(link.attr('data-user-id') || '').trigger('change');
        $('#editTerminationReason').val(link.attr('data-reason') || '');

        var type = link.attr('data-type') || '';
        $('#editTerminationType').val(type).trigger('change');

        $('#editNoticeDate').val(formatDateForInput(link.attr('data-notice-date')));
        $('#editResignDate').val(formatDateForInput(link.attr('data-resign-date')));
    });

    function formatDateForInput(value) {
        if (!value) return '';

        // LocalDateTime normally arrives as yyyy-MM-ddTHH:mm:ss
        var datePart = value.toString().substring(0, 10);
    ...
    /* =========================================================
       DELETE TERMINATION
       ========================================================= */
    $('.delete-termination').on('click', function () {
        $('#deleteTerminationId').val($(this).attr('data-termination-id') || '');
    });
    ...
    var sortItems = $('.termination-sort-item');

    function updateSortButton(text) {
        var button = sortItems.first().closest('.dropdown').find('.dropdown-toggle');
        button.html('<p class="fs-12 d-inline-flex me-1 mb-0">Sort By :</p> ' +
                    text + ' <i class="ti ti-chevron-down ms-1"></i>');
    }
    ...
    function sortWithoutDataTables(type) {
        var tbody = table.find('tbody')[0];
        if (!tbody) return;

        var rows = Array.from(tbody.querySelectorAll('tr[data-termination-id]'));

        rows.sort(function (a, b) {
            if (type === 'recent') {
                return parseInt(b.getAttribute('data-termination-id') || '0', 10) -
                       parseInt(a.getAttribute('data-termination-id') || '0', 10);
            }

            var da = a.cells[4] ? a.cells[4].getAttribute('data-order') || '' : '';
            var db = b.cells[4] ? b.cells[4].getAttribute('data-order') || '' : '';
    ...
    $('#select-all').on('change', function () {
        $('table.datatable tbody input[type="checkbox"]').prop('checked', this.checked);
    });
});
</script>
