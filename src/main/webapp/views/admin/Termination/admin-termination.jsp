                        ...
                        <div class="stack-menu">
                            <div class="nav flex-column align-items-center nav-pills" role="tablist" aria-orientation="vertical">
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <a href="#menu-hrm" role="tab" class="nav-link active" title="HRM" data-bs-toggle="tab" data-bs-target="#menu-hrm" aria-selected="false">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <h6 class="fw-medium">
                                                                        <a href="javascript:void(0);">User ID: ${termination.userId}</a>
                                                                    </h6>
                                                                </div>
                                                            </td>
                                                            <td>-</td>
                                                            ...
                                                            <td>
                                                                <div class="action-icon d-inline-flex">
                                                                    <a href="<c:url value='/termination'><c:param name='action' value='edit'/><c:param name='id' value='${termination.terminationId}'/></c:url>" class="me-2">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="select" name="userId" required>
                                            ...
                                            <option value="1">Anthony Lewis</option>
                                            <option value="2">Brian Villalobos</option>
                                            <option value="3">Doglas Martini</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="modal-body pb-0">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Terminated Employee </label>
                                        <input type="text" class="form-control" value="User ID: ${termination.userId}" readonly>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Notice Date</label>
                                        <div class="input-icon-end position-relative">
                                            <input type="text" name="noticeDate" class="form-control datetimepicker" placeholder="dd/mm/yyyy" value="${termination.noticeDateDisplay}" required>
                                            <span class="input-icon-addon">
												<i class="ti ti-calendar text-gray-7"></i>
											</span>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Reason</label>
                                        <textarea class="form-control" name="reason" rows="3" required>${termination.reason}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Resignation Date</label>
                                        <div class="input-icon-end position-relative">
                                            <input type="text" name="resignDate" class="form-control datetimepicker" placeholder="dd/mm/yyyy" value="${termination.resignDateDisplay}" required>
                                            <span class="input-icon-addon">
												<i class="ti ti-calendar text-gray-7"></i>
											</span>
                                        </div>
...
document.addEventListener("DOMContentLoaded", function () {
    var editModalElement = document.getElementById("edit_termination");
    if (editModalElement && ${not empty termination}) {
        var editModal = new bootstrap.Modal(editModalElement);
        editModal.show();
    }

    document.querySelectorAll('[data-termination-id]').forEach(function (element) {
        element.addEventListener('click', function () {
            var id = this.getAttribute('data-termination-id');
            document.getElementById('deleteTerminationId').value = id;
        });
    });
});
</script>
